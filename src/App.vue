      ...
      <div class="hero-inner">
        ...
        <div class="hero-right">
          ...
          <div class="hero-hosts-row">
            <div class="hero-host-flag">
              <img src="https://flagcdn.com/w80/us.png" alt="Estados Unidos" class="host-flag-img"/>
              <span>USA</span>
            </div>
            <div class="hero-host-flag">
              <img src="https://flagcdn.com/w80/ca.png" alt="Canadá" class="host-flag-img"/>
              <span>CAN</span>
            </div>
            <div class="hero-host-flag">
              <img src="https://flagcdn.com/w80/mx.png" alt="México" class="host-flag-img"/>
              <span>MEX</span>
            </div>
          </div>
        </div>
...
.hero-year-bg {
  ...
  text-shadow: 0 0 80px rgba(255,255,255,.08), 0 2px 4px rgba(0,0,0,.5);
  user-select:none;
}
